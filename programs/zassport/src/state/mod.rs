...
pub struct Identity {
    ...
    // Off-chain attestation flags
    pub age_verified: bool,         // Off-chain verified age
    pub nationality_verified: bool, // Off-chain verified nationality
    pub last_attestation_ts: i64,   // Last off-chain attestation timestamp
}
...
pub struct VerifierConfig {
    pub authority: Pubkey, // Who can change the verifier
    pub verifier: Pubkey,  // Off-chain verifier that can attest
    pub bump: u8,
}
